...
Валидные значения:
* поле "Имя": кириллица, пробел и дефис, от трёх букв
* поле "Телефон": цифры, круглые скобки, пробел, дефис, символ +, от 9 до 14 символов включительно

Позитивный сценарий
1. Переход к анкеты (одним из вариантов навигации)
2. Заполнение валидными данными поля "Имя"
3. Заполнение валидными данными поля "Телефон"
4. Нажать кнопку записаться
5. Переход на страницу с пользовательскими соглашениями

Негативные сценарии
* Заполнение поля "Имя" спецсимволами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение поля "Имя" спецсимволами (****)
3. Заполнение валидными данными поля "Телефон"
4. Нажать кнопку записаться
5. Должно появится сообщение "Использованы недопустимые символы"

* Заполнение поля "Имя" цифрами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение поля "Имя" цифрами (12345)
3. Заполнение валидными данными поля "Телефон"
4. Нажать кнопку записаться
5. Должно появится сообщение "Использованы недопустимые символы"

* Заполнение поля "Имя" латинскими буквами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение поля "Имя" латинскими буквами (Sveta)
3. Заполнение валидными данными поля "Телефон"
4. Нажать кнопку записаться
5. Должно появится сообщение "Использованы недопустимые символы"

* Оставить незаполненным поле "Имя"
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение валидными данными поля "Телефон"
3. Нажать кнопку записаться
4. Должно появится сообщение "Обязательное поле"

* Заполнение поля "Имя" очень длинным словом
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение поля "Имя" словом из 100 букв
3. Поле не должно дать заполнить
4. Должно появится сообщение "Использовано максимум символов"

* Заполнение поля "Телефон" 8 цифрами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение валидными данными поля "Имя"
3. Заполнение поля "Телефон" 8 цифрами (8 909 9999)
4. Нажать кнопку записаться
5. Должно появится сообщение "Номер в формате +9 (999) 999-99-99"

* Заполнение поля "Телефон" 17 цифрами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение валидными данными поля "Имя"
3. Заполнение поля "Телефон" 17 цифрами (8 909 999 99 99999999)
4. Нажать кнопку записаться
5. Должно появится сообщение "Номер в формате +9 (999) 999-99-99"

* Заполнение поля "Телефон" буквами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение валидными данными поля "Имя"
3. Заполнение поля "Телефон" буквами (Алексей)
4. Нажать кнопку записаться
5. Должно появится сообщение "Использованы недопустимые символы"

* Заполнение поля "Телефон" недопустимыми спецсимволами
1.  Переход к анкеты (одним из вариантов навигации)
2. Заполнение валидными данными поля "Имя"
3. Заполнение поля "Телефон" спецсимволами (***********)
4. Нажать кнопку записаться
5. Должно появится сообщение "Использованы недопустимые символы"
...
4. Нажать кнопку записаться
5. Должно появится сообщение "Обязательное поле"


# 2. Перечень используемых инструментов с обоснованием выбора.

1. IDEA (интегрированная среда разработки программного обеспечения для многих языков программирования, в частности Java, JavaScript, Python)
...
3. Разрешение к базе данных
4. Разрешение к API сайта

# 4. Перечень и описание возможных рисков при автоматизации.

1. "Ложные" запросы к менеджерам на обратный звонок
2. Дополнительная нагрузка на сервер
3. Трудности могут возникнуть при поиске локаторов элементов на страницах
